...
class EmiliaTokenizer(Tokenizer):
    ...
    def texts_to_tokens(
        ...
        # Replace literal periods with commas to prevent them from being spoken as "dot"
        # while preserving sentence boundary pauses.
        phoneme_list = [[(p if p != "." else ",") for p in text_phones] for text_phones in phoneme_list]
